...
public class CadastroPedidoBean implements Serializable {
    ...
    private BigDecimal valorFreteAux = new BigDecimal(0.00D);
    ...
    public void atualizarValorTotal() {
        BigDecimal temp = pedido.getValorFrete().subtract(valorFreteAux);
        pedido.setValorTotal(pedido.getValorTotal().add(temp));
        valorFreteAux = pedido.getValorFrete();
    }
...
//</editor-fold>
    ...
    public BigDecimal getValorFreteAux() {
        return valorFreteAux;
    }
    
    public void setValorFreteAux(BigDecimal valorFreteAux) {
        this.valorFreteAux = valorFreteAux;
    }
